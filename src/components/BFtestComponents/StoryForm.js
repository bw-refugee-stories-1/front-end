...
const validationSchema = Yup.object().shape({
    author: Yup.string().required("Type Name"),
    title: Yup.string().required("Type Subject"),
    country: Yup.string().required(),
    body: Yup.string().required("Share a story")
})
...
export default function FormikForm(){
  ...
  return (
    <Formik initialValues={{ author: "", title: "", country: "", body: "" }} 
            ...
            setSubmitting(true);
            axios
            .post("https://refugee POST/stories/submit", values) // <-----add proper post for story submit
            .then(res => {        
              setStatus(res.data);
            })
